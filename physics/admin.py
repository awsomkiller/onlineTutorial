...
from .models import chapter, course, onlinecontent, thought, hcvermacontent, advancearchieve, advancearchievecourse, hcvermacourse
...
admin.site.register(hcvermacourse)