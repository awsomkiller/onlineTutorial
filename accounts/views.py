...
def registerview(request):
    ...
    if form.is_valid():
        ...
        if user !=None:
            ...
            url2 = name[0]+",%20OTP%20to%20Register%20into%20Rkeduv(account)%20is%20"+un+".%20Do%20not%20Share%20with%20anyone.%20-Rkeduv%20abhinm&templateid=1707166618093235089"
            url1 = url1 + url2
